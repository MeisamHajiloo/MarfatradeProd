  ...
  function openInquiryModal(productName, productSlug) {
    ...
    `;
      ...
      whatsappOption.addEventListener("click", function (e) {
        e.preventDefault();
        const message = `Hello, I'm interested in your product: ${productName}. Can you provide more information?`;
        window.open(
      ...
      // Add Telegram link handler (placeholder for now)
      ...
      // Update modal content for the new product
      modal.querySelector(
        ".inquiry-modal-title"
      ).textContent = `Inquire about ${productName}`;

      // Update WhatsApp link
      const whatsappOption = modal.querySelector(".inquiry-option.whatsapp");
      const message = `Hello, I'm interested in your product: ${productName}. Can you provide more information?`;
      whatsappOption.href = `https://wa.me/?text=${encodeURIComponent(
        message
      )}`;
    }
